            ...
            {!goFurther && (
              <>
                <button
                  className="btn-2"
                  onClick={() => {
                    setGoFurther(true), setShowSignIn(true);
                  }}
                >
                  Sign in
                </button>
                <button
                  className="btn-1"
                  onClick={() => {
                    setGoFurther(true), setShowSignUp(true);
                  }}
                >
                  Sign up
                </button>
              ...
              <>
                <div className="welcomeLabel">
                  ...
                  <input
                    ...
                    value={mail}
                    onChange={(e) => {
                      setMail(e.target.value), setAccountDoesntExist('none');
                    }}
                    style={{
                      border:
                        accountDoesntExist !== 'none'
                          ? '0.3vw solid red'
                          : 'none',
                    }}
                  />
                  ...
                  <input
                    ...
                    value={password}
                    onChange={(e) => {
                      setPassword(e.target.value), setPasswordIsWrong('none');
                    }}
                    style={{
                      border:
                        passwordIsWrong !== 'none' ? '0.3vw solid red' : 'none',
                    }}
                  />
                  <p
                    className="smallText"
                  ...
                  <button
                    ...
                    onClick={() => {
                      setGoFurther(false),
                        ...
                        setPassword(''),
                        setShowSignIn(false),
                        setAccountDoesntExist('none'),
                        setPasswordIsWrong('none');
                    }}
                  >
              ...
              <>
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setImg(e.target.files[0]),
                        makePreviewImage(e.target.files[0]),
                        setImgIsntThere('none');
                    }}
                  />
                  <p
                    className="smallText"
                    style={{
                      color: 'red',
                      display: imgIsntThere,
                      fontWeight: '600',
                    }}
                  >
                    *You need a picture in order to use the app!*
                  </p>
                  ...
                  <input
                    ...
                    style={{
                      border:
                        usernameUsed !== 'none' ? '0.3vw solid red' : 'none',
                    }}
                    onChange={(e) => {
                      setUserName(e.target.value), setusernameUsed('none');
                    }}
                  />
                  <p
                    className="smallText"
                  ...
                  >
                    *You need to add valid password*
                  </p>
                  <button
                    className="btn-goFurther"
                    onClick={() => {
                      signUpMail();
                    }}
                  >
