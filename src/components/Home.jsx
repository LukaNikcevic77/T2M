          ...
          <>
                  ...
                  {filterProfiles
                    .filter((profile) => {
                      if (profile.userName != undefined) {
                        ...
                        if (
                          searchProfile !== '' &&
                          usertag.startsWith(searchProfile)
                        ) {
            ...
            <div className="chatGrid">
              <div className="profileITalkTo">
                <img
                  src={profileTalkingTo.profileImage}
                  alt=""
                  className="userImage"
                />
                <p className="mediumSmallText">
                  {profileTalkingTo.profileName}
                </p>
              </div>
              ...
              <div className="messageSending">
                <textarea
                  ...
                  name=""
                  id=""
                  className="messageInput smallText"
